...
public class CreateOthersAdView extends JFrame{
    ...
    private void addComponents() {
        ...
        categoryLabel.setBounds(40, 130, 280, 40);
        categoryLabel.setFont(new Font(Font.SANS_SERIF, BOLD, 24));
        category = new JTextField();
        category.setBounds(310, 130, 150, 40);
        category.setFont(new Font(Font.SANS_SERIF, 0, 24));
        ...
        titleLabel.setBounds(40, 280, 150, 40);
        titleLabel.setFont(new Font(Font.SANS_SERIF, BOLD, 24));
        title = new JTextField();
        title.setBounds(310, 280, 150, 40);
